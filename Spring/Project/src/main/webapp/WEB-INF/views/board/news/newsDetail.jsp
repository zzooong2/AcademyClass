...
<body>
	...
	<section class="container mt-4" style="height: 70vh">
		<div class="card text-center" style="height: 100%">
			<form action="/news/editForm.do" method="GET">
				...
				<div class="card-footer d-flex justify-content-center">
					...
					<c:if test="${sessionScope.memberNo > 0}">
						...
						<button type="button" class="btn btn-danger mx-2" onclick="location.href='/news/delete.do?boardNo=${detail.boardNo}&memberNo=${detail.memberNo}'">삭제</button>
					</c:if>
				</div>
